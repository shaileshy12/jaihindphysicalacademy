...
const Gallery = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Academy Gallery | Jai Hind Physical Academy</title>

        <meta
          name="description"
          content="View training sessions, defence preparation activities, physical exercises and academy moments at Jai Hind Physical Academy in Mumbai."
        />

        <meta
          name="keywords"
          content="Jai Hind Physical Academy gallery, NDA training gallery, Army coaching Mumbai photos, Defence academy images"
        />

        <link
          rel="canonical"
          href="https://jaihindphysicalacademy.com/gallery"
        />
        ...
        <meta
          property="og:title"
          content="Academy Gallery | Jai Hind Physical Academy"
        />

        <meta
          property="og:description"
          content="Explore training sessions, academy activities and defence preparation moments at Jai Hind Physical Academy."
        />

        <meta
          property="og:url"
          content="https://jaihindphysicalacademy.com/gallery"
        />
          ...
          <div className="max-w-6xl mx-auto px-4 pt-16 pb-10 md:pt-20 md:pb-14 grid grid-cols-1 lg:grid-cols-[1.1fr,1fr] gap-10 items-center">
            ...
            <div className="relative h-52 sm:h-64 md:h-72">
              ...
              <div className="absolute right-0 top-4 w-56 sm:w-64 md:w-72 h-40 sm:h-44 md:h-52 rounded-2xl overflow-hidden border border-yellow-400/40 shadow-[0_18px_45px_rgba(0,0,0,0.7)] bg-black">
                <img
                  src={HeroTraining1}
                  alt="Army training session at Jai Hind Physical Academy"
              ...
              <div className="absolute left-0 bottom-4 w-32 sm:w-36 md:w-40 h-24 sm:h-28 md:h-32 rounded-2xl overflow-hidden border border-yellow-400/80 shadow-[0_14px_35px_rgba(0,0,0,0.8)] bg-black">
                <img
                  src={HeroTraining2}
                  alt="Cadets during defence academy practice"
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <div className="absolute left-10 top-0 w-28 sm:w-32 md:w-36 h-20 sm:h-24 md:h-28 rounded-2xl overflow-hidden border border-yellow-400/80 shadow-[0_12px_30px_rgba(0,0,0,0.8)] bg-black">
                <img
                  src={HeroTraining3}
                  alt="Physical training activities"
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
