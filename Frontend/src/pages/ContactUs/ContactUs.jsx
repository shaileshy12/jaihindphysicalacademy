...
const ContactUs = () => {
  ...
  const contactCards = [
    {
      ...
      city: t("branches.borivali.city"),

      name: t("branches.borivali.name"),

      address: t("branches.borivali.address"),

      phone: t("branches.borivali.phone"),
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Jai Hind Physical Academy</title>

        <meta
          name="description"
          content="Contact Jai Hind Physical Academy in Mumbai for Army, NDA, Navy, Air Force and Police training admissions, guidance and academy enquiries."
        />

        <meta
          name="keywords"
          content="Contact Jai Hind Physical Academy, NDA coaching Mumbai contact, Defence academy Borivali, Army training Mumbai"
        />

        <link
          rel="canonical"
          href="https://jaihindphysicalacademy.com/contactus"
        />
        ...
        <meta
          property="og:title"
          content="Contact Us | Jai Hind Physical Academy"
        />

        <meta
          property="og:description"
          content="Get in touch with Jai Hind Physical Academy for defence training admissions and enquiries in Mumbai."
        />

        <meta
          property="og:url"
          content="https://jaihindphysicalacademy.com/contactus"
        />
