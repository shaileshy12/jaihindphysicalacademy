...
const Enquiry = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Admission Enquiry | Jai Hind Physical Academy</title>

        <meta
          name="description"
          content="Submit your enquiry for Army, NDA, Police, SSC and Physical Training admissions at Jai Hind Physical Academy in Mumbai."
        />

        <meta
          name="keywords"
          content="NDA admission Mumbai, Army training enquiry, Police academy enquiry Mumbai, Defence academy admissions"
        />

        <link
          rel="canonical"
          href="https://jaihindphysicalacademy.com/enquiry"
        />
        ...
        <meta
          property="og:title"
          content="Admission Enquiry | Jai Hind Physical Academy"
        />

        <meta
          property="og:description"
          content="Apply for Army, NDA, Police and Physical Training programs at Jai Hind Physical Academy."
        />

        <meta
          property="og:url"
          content="https://jaihindphysicalacademy.com/enquiry"
        />
