...
const Vision = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Vision | Jai Hind Physical Academy</title>

        <meta
          name="description"
          content="Explore the vision of Jai Hind Physical Academy in building disciplined, confident and service-ready candidates for Army, NDA, Navy, Air Force and Police careers."
        />

        <meta
          name="keywords"
          content="Vision Jai Hind Physical Academy, NDA vision Mumbai, Army coaching Borivali, Defence academy vision"
        />

        <link
          rel="canonical"
          href="https://jaihindphysicalacademy.com/vision"
        />
        ...
        <meta
          property="og:title"
          content="Our Vision | Jai Hind Physical Academy"
        />

        <meta
          property="og:description"
          content="Discover the vision and long-term goals of Jai Hind Physical Academy for defence aspirants."
        />

        <meta
          property="og:url"
          content="https://jaihindphysicalacademy.com/vision"
        />
                ...
                <aside className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px] sm:text-[12px]">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3">
                      ...
                      <p className="text-gray-600 mt-1">{t("nationDesc")}</p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3">
                      ...
                      <p className="text-gray-600 mt-1">{t("studentDesc")}</p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-emerald-300 bg-emerald-50 px-4 py-3 text-[12px]">
                    ...
                    <p className="text-gray-800">{t("standsForText")}</p>
                  </div>
                </aside>
              </div>
