...
const DirectorDesk = () => {
  ...
  const { t, i18n } = useTranslation("directordesk");

  return (
    <>
      <Helmet>
        <title>Director's Desk | Jai Hind Physical Academy</title>

        <meta
          name="description"
          content="Message from the director of Jai Hind Physical Academy about defence training, discipline, student success and preparation for Army, NDA and Police careers."
        />

        <meta
          name="keywords"
          content="Director Jai Hind Physical Academy, NDA mentor Mumbai, Army coaching director, Defence academy Borivali"
        />

        <link
          rel="canonical"
          href="https://jaihindphysicalacademy.com/director-desk"
        />
        ...
        <meta
          property="og:title"
          content="Director's Desk | Jai Hind Physical Academy"
        />

        <meta
          property="og:description"
          content="Read the director's vision and message for defence aspirants at Jai Hind Physical Academy."
        />

        <meta
          property="og:url"
          content="https://jaihindphysicalacademy.com/director-desk"
        />
